...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 08 sep. 2025 à 18:39
...
INSERT INTO `contributions` (`id`, `partner_id`, `food_request_id`, `amount`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `distributions` (`id`, `donation_id`, `user_id`, `quantity_distributed`, `distribution_date`, `status`, `notes`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `donations` (`id`, `food_request_id`, `user_id`, `title`, `description`, `image`, `quantity`, `unit`, `latitude`, `longitude`, `available_until`, `status`, `expiration_date`, `need_volunteers`, `volunteer_note`, `category`, `min_quantity`, `donor_type`, `available_from`, `available_to`, `city`, `postal_code`, `created_at`, `updated_at`, `partner_id`) VALUES
...
INSERT INTO `donation_volunteer` (`id`, `donation_id`, `volunteer_id`, `volunteered_at`) VALUES
...
INSERT INTO `food_requests` (`id`, `organization_id`, `title`, `description`, `quantity`, `target_amount`, `needed_before`, `created_at`, `updated_at`, `paypal_link`) VALUES
...
CREATE TABLE `food_request_donations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `food_request_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `quantity` int(11) NOT NULL,
...
INSERT INTO `food_request_donations` (`id`, `food_request_id`, `user_id`, `quantity`, `unit`, `available_until`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `food_waste_reports` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `food_waste_reports` (`id`, `user_id`, `category`, `quantity`, `description`, `latitude`, `longitude`, `reported_at`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `organization_partner_requests` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `organization_id` bigint(20) UNSIGNED NOT NULL,
  `partner_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `partners` (`id`, `name`, `type`, `document_path`, `document_request_token`, `document_request_expires_at`, `contact_email`, `contact_phone`, `address`, `status`, `sponsor_level`, `level`, `created_at`, `updated_at`, `user_id`, `role`, `linked_partner_id`) VALUES
...
INSERT INTO `partner_requests` (`id`, `partner_id`, `user_id`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `pickups` (`id`, `donation_id`, `user_id`, `scheduled_at`, `status`, `notes`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `places` (`id`, `user_id`, `title`, `description`, `address`, `google_maps_link`, `contact_info`, `availability`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `place_photos` (`id`, `place_id`, `path`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `sponsorship_tiers` (`id`, `name`, `price`, `duration_days`, `features`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `name`, `email`, `document_path`, `document_request_token`, `document_request_expires_at`, `profile_image`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `real_name`) VALUES
...
INSERT INTO `user_preferences` (`id`, `user_id`, `preferred_categories`, `min_quantity`, `max_distance`, `available_from`, `available_until`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `volunteers` (`id`, `user_id`, `phone`, `skills`, `availability`, `document_path`, `verification_status`, `verification_note`, `verification_requested_at`, `created_at`, `updated_at`) VALUES
